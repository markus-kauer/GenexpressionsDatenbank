...
/*!
 * Diese Datei basiert auf dem jQuery ComboTree Plugin von Erhan FIRAT,
 * modifiziert von Markus Kauer für eine Bachelorarbeit.
 * Das ursprüngliche Plugin ist lizenziert unter der MIT-Lizenz.
 */
...
(function ($, window, document, undefined) {
  ...
  ComboTree.prototype.init = function () {
    ...
    // Modifiziert das kein Pfeil mehr angezeigt wird
    ...
    // Modifiziert
    this._dropDownContainer.html(this.createSourceHTML()).show();
    //
  ...
  ComboTree.prototype.unbind = function () {
    // modifiziert, dass kein Pfeil mehr angezeigt wird
  ...
  ComboTree.prototype.bindings = function () {
    ...
    // modifiziert, nun nicht mehr möglich
  ...
  // Modifiziert, dass nicht mehr alle Checks
